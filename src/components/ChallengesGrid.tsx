  ...
  return (
    <div style={{
      ...
      {challenges.map((challenge, index) => {
        // Calculate total points: streak * point value
        const totalPoints = (challenge.streak || 0) * (challenge.challenge_points || 0);
